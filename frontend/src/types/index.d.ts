...
export type Category = 'Analgésicos' | 'Antibióticos' | 'Vitaminas' | 'Higiene' | 'Dermocosméticos' | 'Infantil' | 'Genéricos' | 'Primeiros socorros';
...
export type Route = 'dashboard' | 'estoque' | 'vendas' | 'solicitados' | 'pedidos' | 'historico' | 'contagem' | 'relatorios' | 'assistente';
